...
public class WorkspaceSaveableCompareInput extends SaveableCompareEditorInput {

	public WorkspaceSaveableCompareInput(CompareConfiguration configuration, IWorkbenchPage page) {
...
//			return true;
//		}
//		if (obj instanceof WorkspaceSaveableCompareInput other) {
